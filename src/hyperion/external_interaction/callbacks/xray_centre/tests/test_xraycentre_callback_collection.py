...
@pytest.fixture()
def eiger() -> Generator[EigerDetector, None, None]:
...
def test_communicator_in_composite_run(
    ...
    RE(run_gridscan_and_move(flyscan_xray_centre_composite, params, callbacks))
    ...
    # zocalo
    callbacks.zocalo_handler.zocalo_interactor.wait_for_result.assert_called_once()
    callbacks.zocalo_handler.zocalo_interactor.run_start.assert_called_once()
    callbacks.zocalo_handler.zocalo_interactor.run_end.assert_called_once()
