...
.. _GitHub: https://github.com/dls-controls/python-artemis/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/dls-controls/python-artemis.git
    $ cd python-artemis
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://dls-controls.github.io/python-artemis/releases
